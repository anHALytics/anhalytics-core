...
CREATE TABLE IF NOT EXISTS `anhalytics`.`PART_OF` (
  ...
  `end_date` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`organisation_motherID`, `organisationID`),
