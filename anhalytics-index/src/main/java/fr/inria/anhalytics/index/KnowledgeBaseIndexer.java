    ...
    public int indexOrganisations() throws SQLException {
        ...
        if (isIndexExists(IndexProperties.getKbIndexName())) {
            ...
            for (Organisation org : organisations) {
                ...
                List<Map<String, Object>> allOrgRelationsDocument = new ArrayList<Map<String, Object>>();
                for (PART_OF partOf : org.getRels()) {
                    Organisation organisation_mother = partOf.getOrganisation_mother();
                    Map<String, Object> motherOrganisationDocument = organisation_mother.getOrganisationDocument();
                    Address motheraddr = (adao.getOrganisationAddress(organisation_mother.getOrganisationId()));
